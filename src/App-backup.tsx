...
// Interfaz para los repositorios
  ...
  useEffect(() => {
    ...
    fetch("https://api.github.com/users/Emcas152/repos?sort=updated&per_page=50")
      ...
      .then((data: Repository[]) => {
        // Filtrar repositorios que no sean forks y ordenar por estrellas y actividad
        const filtered = data
          .filter((repo) => !repo.name.includes('fork'))
          .sort((a, b) => {
            // Priorizar repositorios con más estrellas y más recientes
        ...
        <section className="text-center py-20 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="relative inline-block mb-8">
              <img
                src="https://avatars.githubusercontent.com/u/Emcas152"
                alt="Edwin Castillo"
            ...
            <Card key={repo.id}>
              <CardContent className="p-4 space-y-2">
                ...
                <a
                  href={repo.html_url}
                  target="_blank"
                  className="text-sm text-white bg-teal-600 px-3 py-1 rounded inline-block"
                >
                  View on GitHub
                </a>
              </CardContent>
